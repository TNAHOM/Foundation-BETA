# Generated by Django 4.1.2 on 2022-11-13 21:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_grade', multiselectfield.db.fields.MultiSelectField(choices=[(9, 9), (10, 10), (11, 11), (12, 12)], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_score', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('to', models.CharField(choices=[('Student', 'Student'), ('Teacher', 'Teacher'), ('Parents', 'Parents'), ('School Administrator', 'School Administrator'), ('Super User', 'Super User')], max_length=33)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_grade', multiselectfield.db.fields.MultiSelectField(choices=[(9, 9), (10, 10), (11, 11), (12, 12)], max_length=33)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('class_grade', multiselectfield.db.fields.MultiSelectField(choices=[(9, 9), (10, 10), (11, 11), (12, 12)], max_length=2)),
                ('section', multiselectfield.db.fields.MultiSelectField(choices=[('A', 'A'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('E', 'E')], max_length=1)),
                ('school_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.school')),
            ],
            bases=('base.user',),
            managers=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.school')),
                ('teacher', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.teacher')),
            ],
        ),
        migrations.CreateModel(
            name='Parent',
            fields=[
                ('user_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('student_p', models.CharField(max_length=100)),
                ('school_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.school')),
            ],
            bases=('base.user',),
            managers=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.CharField(default='Z', max_length=1)),
                ('home_room', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.teacher')),
